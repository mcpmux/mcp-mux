...
impl ConnectionContext {
    ...
    pub fn manual(space_id: Uuid, server_id: impl Into<String>, transport: ResolvedTransport) -> Self {
    ...
    pub fn auto(space_id: Uuid, server_id: impl Into<String>, transport: ResolvedTransport) -> Self {
